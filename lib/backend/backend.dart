...
Stream<List<ProcuraPurosRecord>> queryProcuraPurosRecord(
    ...
    queryCollection(
        ProcuraPurosRecord.collection, ProcuraPurosRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<ProcuraPurosRecord>> queryProcuraPurosRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(
...
Future<FFFirestorePage<ProcuraPurosRecord>> queryProcuraPurosRecordPage({
  Query Function(Query) queryBuilder,
